...
namespace P4_2_1204053
{
  ...
  MessageBoxDefaultButton.Button1);
                    ...
                    MessageBox.Show("You canceled the open file operation", "Warning", MessageBoxButtons.OK,
                        MessageBoxIcon.Warning, MessageBoxDefaultButton.Button1, MessageBoxOptions.RightAlign);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message.ToString(), "Eror", MessageBoxButtons.OK, MessageBoxIcon.Stop);
            }
        }
    }
}
